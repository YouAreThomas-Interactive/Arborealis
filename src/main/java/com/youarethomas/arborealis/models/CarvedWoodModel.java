...
public class CarvedWoodModel implements UnbakedModel, BakedModel, FabricBakedModel {
    ...
    public BakedModel bake(ModelLoader loader, Function<SpriteIdentifier, Sprite> textureGetter, ModelBakeSettings rotationContainer, Identifier modelId) {
        ...
        UnbakedModel template = loader.getOrLoadModel(new Identifier("arborealis:block/carved_wood_template"));
        ...
        template.bake(loader, textureGetter, rotationContainer, modelId);
